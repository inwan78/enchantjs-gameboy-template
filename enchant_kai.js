...
/*現在ではrequestAnimationFrameのみで対応可能なので消去
...
(function() {
    ...
    enchant.Core = enchant.Class.create(enchant.EventTarget, {
        ...
        initialize: function(width, height) {
             ...
             * @type Number
             */
            this.fps = 60;//固定（もう使っていないので意味はない）
            this.fpsRate = 2;//この数字で割った数値が実際のFPS
            this.rateCount = 0;//FPSコントロール用のカウント
            /**
...
///////////////////////////////////////////////////////////////////////////////
        ...
        _tick: function(time) {
            ...
            this._requestNextFrame();//更新処理
            if(this.fpsRate > ++this.rateCount){//FPSレートになってなければ抜ける
                return;
            }
            this.rateCount = 0;
...
enchant.LoadingScene = enchant.Class.create(enchant.Scene, {
    ...
    initialize: function() {
        ...
        var barWidth = this.width * 0.8 | 0;
        var barHeight = this.width * 0.03 | 0;
        var border = barWidth * 0.01 | 0;
        ...
        label2.color = 'white';
        label2.font = '20px sans-serif';
        label2.moveTo(400, (this.height - barHeight) / 2 - 25);
        label2.text = "now loading."
